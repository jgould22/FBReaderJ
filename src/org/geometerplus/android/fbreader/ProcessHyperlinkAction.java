	...
	private void openInBrowser(final String urlString) {
		...
		new Thread(new Runnable() {
			public void run() {
				...
				//Check if its a local HTML file, used to open html files generated by MathMLTagAction.java 
				if(urlString.endsWith("html") && urlString.startsWith("/")){
				    ...
				    intent.setClass(BaseActivity, MathMLWebViewActivity.class);
				    
				    intent.putExtra("fileLocation", urlString);
